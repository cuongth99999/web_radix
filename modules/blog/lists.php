...
FROM blog INNER JOIN blog_categories ON 
    blog.category_id=blog_categories.id ORDER BY blog.create_at DESC LIMIT $offset, $perPage");
                ...
                <div class="pagination-main">
                    <ul class="pagination">
                        ...
                        for ($index = $begin; $index <= $end; $index++) {
                            ...
                            echo '<li class="'.$classAtive.'"><a href="'._WEB_HOST_ROOT.'/blog-page-'.$index.'.html">'.$index.'</a></li>';
                        }
