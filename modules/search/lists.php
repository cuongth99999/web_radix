...
WHERE blog.title LIKE '%$keyword%' OR blog.content LIKE '%$keyword%' ORDER BY blog.create_at DESC LIMIT $offset, $perPage");
                        ...
                        <div class="pagination-main">
                            <ul class="pagination">
                                ...
                                for ($index = $begin; $index <= $end; $index++) {
                                    ...
                                    echo '<li class="'.$classAtive.'"><a href="'._WEB_HOST_ROOT.'?module=search&keyword='.$keyword.'&page='.$index.'">'.$index.'</a></li>';
                                }
